...
This is an optional **zero-additional-cost** fallback relay for the Streamlit Community Cloud deployment. The active deployment currently uses the Supabase Edge Function under `supabase/functions/`.
